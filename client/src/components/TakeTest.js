...
function TakeTest(){
        ...
        let questions = []
        axios.post(`http://localhost:9000/test/${localStorage.getItem('testId')}`).then(resp => {
           quiz = resp.data
           quiz.questions.forEach(q => (axios.post(`http://localhost:9000/question/${q}`)).then(resp => {
            ...
            <>
                  ...
                  <div className="take-quiz-wrapper">
                          ...
                          <div className="content">
                              ...
                              <div className="body">
                                  <div className="left">
                                      <div className="question-name">{questions[activeQuestionIdx].question}</div>
